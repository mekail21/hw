...
del ua
"""
Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/RP2A.{random.randint(111111,999999)}.{random.randint(111,999)})  [FBAN/EMA;FBBV/352223683;FBAV/291.0.0.12.110;FBDV/SM-G935ES;FBLC/en_GB;FBNG/WIFI;FBMNT/NOT_METERED;FBDM/{density=1.0125}]
"""
